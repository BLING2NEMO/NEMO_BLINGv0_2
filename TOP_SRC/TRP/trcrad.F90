...
CONTAINS
   ...
   SUBROUTINE trc_rad( kt )
      ...
      IF( lk_bling   ) THEN
        CALL trc_rad_sms( kt, trb, trn, jp_bling0  , jp_bling0+1, cpreserv='Y' )  ! BLINGv0 model PO4, DOP
        CALL trc_rad_sms( kt, trb, trn, jp_bling0+2, jp_bling0+3               )  ! BLINGv0 model iron, oxygen
        CALL trc_rad_sms( kt, trb, trn, jp_bling0+4, jp_bling0+4, cpreserv='Y' )  ! BLINGv0 model DIC
        CALL trc_rad_sms( kt, trb, trn, jp_bling0+5, jp_bling0+5               )  ! BLINGv0 model alkalinity
      ENDIF
