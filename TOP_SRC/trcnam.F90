MODULE trcnam
   ...
   USE trcnam_bling      ! BLING namelist
...
#  include "top_substitute.h90"
   ...
   !! $Id: trcnam.F90 4362 2014-01-22 09:32:46Z cetlod $ 
...
CONTAINS
   ...
   SUBROUTINE trc_nam
      ...
      !
      DO jn = 1, jptra
         WRITE( sn_tracer(jn)%clsname,'("TR_",I2.2)'           ) jn
      ...
      IF( lk_bling   ) THEN   ;   CALL trc_nam_bling        ! BLING  tracers
      ELSE                    ;   IF(lwp) WRITE(numout,*) '          BLING not used'
      ENDIF
